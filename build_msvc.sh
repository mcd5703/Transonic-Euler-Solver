...
if [ ! -d "matplotplusplus" ]; then
    ...
    cmake -DCMAKE_INSTALL_PREFIX="${project_root_dir}/third_party/matplotplusplus/install" -DCMAKE_BUILD_TYPE=Debug -DMATPLOTPP_BUILD_TESTS:BOOL=OFF -DMATPLOTPP_BUILD_EXAMPLES:BOOL=OFF ..
